          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6 p-0 d-flex justify-content-center">
                <img :src="state.activeKeep.img" class="img-fluid rounded" alt="">
              </div>
              <div class="col">
                <div class="row">
                ...
                <div class="row">
                  <div class="col">
                    <div class="text-wrap" v-if="state.activeKeep.creator">
                      <router-link title="go to Profile" :to="{name:'ProfilePage', params:{id: state.activeKeep.creatorId}}" data-dismiss="modal" class="d-flex justify-content-end mt-5">
